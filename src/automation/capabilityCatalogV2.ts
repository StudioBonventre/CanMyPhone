...
export const CAPABILITY_CATALOG_V2: readonly CapabilityV2[] = [
  ...
  cap({id:"system.flashlight.set",category:"system",provider:"ios",role:"action",description:"Taschenlampe setzen",executionModes:["DIRECT_PUBLIC_API","APP_INTENT","SHORTCUT"],risk:"low",requiresPro:false,publicApi:true,background:false,confirmation:false,permissions:[],parameters:{value:{type:"string",required:true,values:["on","off"]}},inputs:[],outputs:[],fallback:"SHORTCUT",availability:"ios"}),
  cap({id:"system.clipboard.set",category:"system",provider:"ios",role:"action",description:"Zwischenablage setzen",executionModes:["DIRECT_PUBLIC_API","APP_INTENT","SHORTCUT"],risk:"low",requiresPro:false,publicApi:true,background:false,confirmation:false,permissions:[],parameters:{value:{type:"string",required:true}},inputs:["text"],outputs:[],fallback:"SHORTCUT",availability:"ios"}),
  cap({id:"system.url.open",category:"system",provider:"ios",role:"action",description:"Dokumentierte URL öffnen",executionModes:["DIRECT_PUBLIC_API","APP_INTENT","SHORTCUT"],risk:"medium",requiresPro:false,publicApi:true,background:false,confirmation:true,permissions:[],parameters:{url:{type:"string",required:true}},inputs:[],outputs:[],fallback:"GUIDED_HANDOFF",availability:"ios"}),
  ...
  cap({id:"navigation.route.start",category:"navigation",provider:"apple-maps",role:"action",description:"Route starten",executionModes:["DIRECT_PUBLIC_API","APP_INTENT","SHORTCUT"],risk:"low",requiresPro:false,publicApi:true,background:false,confirmation:false,permissions:[],parameters:{destination:{type:"string",required:true}},inputs:[],outputs:[],fallback:"GUIDED_HANDOFF",availability:"ios"}),
  ...["message.compose","mail.compose","call.start"].map((name)=>cap({id:`communication.${name}`,category:"communication",provider:"ios",role:"action",description:name,executionModes:["DIRECT_PUBLIC_API","APP_INTENT","SHORTCUT"],risk:"medium",requiresPro:false,publicApi:true,background:false,confirmation:true,permissions:[],parameters:{recipient:{type:"string",required:true}},inputs:[],outputs:[],fallback:"GUIDED_HANDOFF",availability:"ios"})),
  cap({id:"productivity.calendar.create",category:"productivity",provider:"eventkit",role:"action",description:"Kalendereintrag erstellen",executionModes:["DIRECT_PUBLIC_API","APP_INTENT","SHORTCUT"],risk:"medium",requiresPro:false,publicApi:true,background:true,confirmation:false,permissions:["calendar"],parameters:{title:{type:"string",required:true},start:{type:"string",required:true},end:{type:"string",required:false},notes:{type:"string",required:false}},inputs:["text"],outputs:["event"],fallback:"SHORTCUT",availability:"ios"}),
  cap({id:"productivity.reminder.create",category:"productivity",provider:"eventkit",role:"action",description:"Erinnerung erstellen",executionModes:["DIRECT_PUBLIC_API","APP_INTENT","SHORTCUT"],risk:"low",requiresPro:false,publicApi:true,background:true,confirmation:false,permissions:["reminders"],parameters:{title:{type:"string",required:true},due:{type:"string",required:false},notes:{type:"string",required:false}},inputs:["text"],outputs:["reminder"],fallback:"SHORTCUT",availability:"ios"}),
  ...
  cap({id:"smart-home.scene.run",category:"smart-home",provider:"homekit",role:"action",description:"Apple-Home-Szene ausführen",executionModes:["DIRECT_PUBLIC_API","APP_INTENT","SHORTCUT"],risk:"medium",requiresPro:true,publicApi:true,background:true,confirmation:false,permissions:["home"],parameters:{scene:{type:"string",required:true},home:{type:"string",required:false}},inputs:[],outputs:[],fallback:"SHORTCUT",availability:"ios"}),
