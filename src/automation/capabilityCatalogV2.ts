...
export const CAPABILITY_CATALOG_V2: readonly CapabilityV2[] = [
  ...
  cap({id:"smart-home.cover.open",category:"smart-home",provider:"provider-router",role:"action",description:"Rollladen oder Beschattung öffnen",executionModes:["THIRD_PARTY_API"],risk:"medium",requiresPro:true,publicApi:true,background:true,confirmation:false,permissions:["provider-connection"],parameters:{provider:{type:"string",required:true},room:{type:"string",required:true},device:{type:"string",required:false}},inputs:["cover"],outputs:["provider-result"],fallback:"GUIDED_HANDOFF",availability:"ios"}),
  ...
  cap({id:"smart-home.light.set",category:"smart-home",provider:"provider-router",role:"action",description:"Licht setzen",executionModes:["THIRD_PARTY_API"],risk:"low",requiresPro:true,publicApi:true,background:true,confirmation:false,permissions:["provider-connection"],parameters:{provider:{type:"string",required:true},room:{type:"string",required:true},value:{type:"string",required:true}},inputs:["light"],outputs:["provider-result"],fallback:"GUIDED_HANDOFF",availability:"ios"}),
  cap({id:"smart-home.climate.set",category:"smart-home",provider:"provider-router",role:"action",description:"Temperatur oder Klima setzen",executionModes:["THIRD_PARTY_API"],risk:"medium",requiresPro:true,publicApi:true,background:true,confirmation:false,permissions:["provider-connection"],parameters:{provider:{type:"string",required:true},room:{type:"string",required:true},value:{type:"string",required:true}},inputs:["climate"],outputs:["provider-result"],fallback:"GUIDED_HANDOFF",availability:"ios"}),
